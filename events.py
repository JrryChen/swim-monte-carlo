...
EVENTS_2024_PARIS: dict[str, EventConfig] = {
    ...
    "men_100_back":   EventConfig("Men's 100m Backstroke",  "2dc1a08d-6d97-4c51-a2ec-bae9b6be7805", "Men's 100m Backstroke",   51.85,  100),
    ...
    "men_200_breast": EventConfig("Men's 200m Breaststroke","37640ce4-9eea-4db7-b508-e063fea542dc", "Men's 200m Breaststroke", 126.12,  200),
    "men_100_fly":    EventConfig("Men's 100m Butterfly",   "a2908685-0394-427e-92b0-349062eae8eb", "Men's 100m Butterfly",    49.45,  100),
    "men_200_fly":    EventConfig("Men's 200m Butterfly",   "50d7c38c-af49-431e-bab9-5a741c5ff1eb", "Men's 200m Butterfly",   110.73,  200),
    "men_200_im":     EventConfig("Men's 200m Medley",      "c80486d5-c757-4ce4-88fe-da285406e563", "Men's 200m Medley",      114.00,  200),
    "men_400_im":     EventConfig("Men's 400m Medley",      "b7c24320-4b6f-4b66-9d87-f4ac1f92a857", "Men's 400m Medley",      243.84,  400),
    # ── Women ────────────────────────────────────────────────────────────────
    "women_50_free":    EventConfig("Women's 50m Freestyle",    "0f25b781-6cd3-4a36-ba61-49ec4789d278", "Women's 50m Freestyle",     23.67,   50),
    "women_100_free":   EventConfig("Women's 100m Freestyle",   "f4a7ea40-3136-4687-a43b-91344071a74d", "Women's 100m Freestyle",    51.71,  100),
    "women_200_free":   EventConfig("Women's 200m Freestyle",   "1dfbd513-4a68-4bc7-aeac-6ee2ebd75692", "Women's 200m Freestyle",   112.98,  200),
    "women_400_free":   EventConfig("Women's 400m Freestyle",   "434f93ff-a415-4bcd-a4ce-a38a20c6ca97", "Women's 400m Freestyle",   236.46,  400),
    ...
    "women_100_back":   EventConfig("Women's 100m Backstroke",  "a39cfa67-1c51-4832-8deb-51ccbfabe7be", "Women's 100m Backstroke",   57.45,  100),
    "women_200_back":   EventConfig("Women's 200m Backstroke",  "69526061-d4aa-4c91-8a77-0922b141ec65", "Women's 200m Backstroke",  123.35,  200),
    ...
    "women_200_breast": EventConfig("Women's 200m Breaststroke","0dadd671-7c1e-4363-9a56-7674285abb1e", "Women's 200m Breaststroke", 138.95,  200),
    "women_100_fly":    EventConfig("Women's 100m Butterfly",   "69fb6b1b-04da-4032-83dd-73290d1106b7", "Women's 100m Butterfly",    55.48,  100),
    ...
    "women_400_im":     EventConfig("Women's 400m Medley",      "e138040c-91ef-45bb-a10c-16ccf8c335cb", "Women's 400m Medley",      266.36,  400),
}
