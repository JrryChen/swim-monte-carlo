...
DEFAULT_SIGMA = 0.3486  # seconds per 50m — fallback when athlete has only 1 recorded time; scaled by distance/50
DEFAULT_TAU = 0.2596    # seconds per 50m — fallback exponential component; scaled by distance/50
...
SIGMA_DISTANCE_EXP = 0.6010  # exponent for fallback sigma/tau scaling: effective = default * (distance/50)^exp
